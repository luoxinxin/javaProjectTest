...
public class test {
    ...
    public void completTask() {
        ...
        Task task = taskService.createTaskQuery().processDefinitionKey("process_955").taskAssignee("finance").singleResult();
        //完成任务，参数：任务id
...
//        repositoryService.deleteDeployment(deploymentId,true);
    ...
    public void findHistoryInfo(){
        ...
        //根据instanceId查询整个流程
        instanceQuery.processInstanceId("2501").orderByHistoricActivityInstanceStartTime().asc();
